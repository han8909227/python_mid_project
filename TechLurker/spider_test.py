...
# from scripts.my_scraper.my_scraper.spiders.reddit_dp_spider import Reddit_dp
...
#         @returns requests 1
#         """
#         return Request('https://www.reddit.com/r/dailyprogrammer/', callback=self.returns_item)
