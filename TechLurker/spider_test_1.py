...
# from scripts.my_scraper.my_scraper.spiders.reddit_lp_spider import Reddit_lp
...
# class Spider1(Reddit_lp):
#     name = 'demo_spider'


# # class Spider2(Reddit_lp):
# #     name = 'demo_spider'

#     def returns_request(self, response):
#         """ method which returns request
#         """
#         return Request("https://www.reddit.com/r/learnprogramming/", callback=self.returns_item)
